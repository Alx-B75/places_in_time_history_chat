    ...
    <div style={{padding:24, maxWidth:500, margin:'40px auto'}}>
      ...
      <form onSubmit={submit}>
        ...
        <label style={{display:'flex',gap:8,alignItems:'flex-start',marginTop:8}}>
          ...
          <span>I consent to processing of my data in line with the privacy policy (GDPR).</span>
        </label>
        <label style={{display:'flex',gap:8,alignItems:'flex-start'}}>
          <input type="checkbox" checked={aiAck} onChange={e=>setAiAck(e.target.checked)} />
          <span>I understand answers are generated by AI and may be inaccurate.</span>
        </label>
